...
metrics:
  - { label: "Codebase", value: "~10.6k LOC C++ + ~4.5k LOC TS", source: "commonroad: wc -l over lib/app/examples/tests/parameters (10,642) and web-sdk *.ts (4,491)" }
  ...
  - { label: "Test suite", value: "19 test files, 19 CTest targets", source: "commonroad: CMakeLists.txt add_test x19; tests/test_*.cpp+py count=19" }
